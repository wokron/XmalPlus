...
if __name__=='__main__':
	path = r"D:\xiebingshu\Desktop\android\Xmal-master\experiment\apk"
	dataPath = r"D:\xiebingshu\Desktop\android\Xmal-master\experiment\api"
	fileName = r"testapk"
	adapter = GetAPI()
	adapter.getAPICalls(path, fileName, dataPath)
